    ...
    dispatch(
      setRows([
        ...personaState.rows,
        {
          ...data,
          id: uuiv4(),
          contract_rule_name: data.ruleset_name,
          datasets: Math.floor(Math.random() * 10),
          consumers: Math.floor(Math.random() * 100),
          max_daily_limit: Math.floor(Math.random() * 10000),
          validity: `${Math.floor(Math.random() * 10) + 1} years`,
          max_rate_limit: `${Math.floor(Math.random() * 100) + 1} / sec`,
        },
      ])
    );

    dispatch(setCloseModal("addPersonaForm"));
    showAlert("Persona added successfully", "success");
  };
        ...
        >
          ...
          <div className="flex justify-center gap-x-4 my-4">
            <Button
              ...
              intent={"secondary"}
              className="w-[164px]"
              onClick={() => dispatch(setCloseModal("addPersonaForm"))}
            >
              Cancel
            </Button>
