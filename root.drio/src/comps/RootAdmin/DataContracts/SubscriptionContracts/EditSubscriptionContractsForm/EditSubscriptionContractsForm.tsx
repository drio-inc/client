...
export default function EditSubscriptionContractsForm({ row }: TableRow) {
      ...
      <Layout>
        <div className="flex items-center justify-center bg-white mb-4 py-12 rounded-lg">
          <div className="rounded-full shadow-xl h-20 w-20 flex justify-center items-center mr-4 -mt-4">
            <Image src="/images/DJI_Innovations.png" alt="contract" width={40} height={40} />
          </div>
          <h2 className="text-gray-700 font-medium">
            Contract created by DT for B Bank <br /> to allow Access to DT’s datasets
          </h2>
        </div>
        ...
        <Form form={form} onSubmit={onSubmit}>
          <div className="mx-auto bg-white p-4 rounded-lg max-w-5xl">
            <div className="flex flex-wrap -m-2 rounded-lg my-4">
              ...
              <div className="flex justify-between w-full px-4 my-4">
                <div>
                  <h3 className="text-xl font-semibold mb-2">App Personas Allowed</h3>
              ...
              <div className="flex justify-between w-full my-4 px-4">
                <div>
                  <h3 className="text-xl font-semibold mb-2">Datasets Covered</h3>
              ...
              <div className="flex flex-col items-end my-4 w-full">
                <div>
                  <div className="flex gap-x-2">
                    <Image src="/images/DJI_Innovations.png" alt="logo" width={40} height={40} />

                    <span>Cox Automotive Signatory</span>
                  </div>

                  <Image src="/images/signature-2.png" alt="logo" width={300} height={300} />
          ...
          <div className="mx-auto bg-white p-4 rounded-lg max-w-5xl mt-4">
            <div className="flex items-center justify-center mb-4 py-4 rounded-lg">
              <Image src="/images/card.png" alt="contract" width={80} height={80} />
            ...
            <div className="flex justify-between w-full px-4 my-4">
              <div>
                <h3 className="text-xl font-semibold mb-4">B Bank Global Resources</h3>
              ...
              <div>
                ...
                <div className="flex flex-col gap-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-blue-500 underline">ldap://coreldap.bbank.com</span>
                    <AiFillCaretRight className="text-blue-500 " />
                  </div>
            ...
            <div className="flex flex-col items-end my-4">
              <div>
                ...
                <Image src="/images/signature.png" alt="logo" width={300} height={300} />
            ...
            <div className="px-2 py-2 flex gap-4 justify-center mt-4">
              ...
              <Button type="button" intent={`primary`} onClick={() => onSubmit(form.getValues())}>
