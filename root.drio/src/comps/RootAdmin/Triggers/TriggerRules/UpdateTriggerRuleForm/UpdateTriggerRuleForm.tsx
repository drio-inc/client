...
const ruleTemplateOptions = [
  {
    id: "po_delayed_trigger",
    rule_name: "PO Delayed Trigger",
    streams: [
      {
...
export default function UpdateTriggerRuleForm({ row }: TableRow) {
  ...
  const [tabValue, setTabValue] = useState("rule" as "rule" | "stream" | "trigger");
  const [openTriggerChannelPopover, setOpenTriggerChannelPopover] = useState(false);
      ...
      <Form {...form}>
        ...
        >
          ...
          <Tabs
            ...
            onValueChange={(val) => setTabValue(val as "rule" | "stream" | "trigger")}
          >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel className="text-gray-700">Rule Template</FormLabel>
                      <Popover
                                ...
                                {ruleTemplateOptions.map((template) => (
                                  <CommandItem
                                    ...
                                    onSelect={() => {
                                      ...
                                      if (template.id === "po_delayed_trigger") {
                                        form.setValue(
                                          "rule_description",
            ...
            <TabsContent value="trigger">
              <div className="flex items-center justify-between gap-x-4 px-4">
                <span className="text-[20px] text-gray-700 font-medium">Trigger</span>
                <button
                  type="button"
                ...
                >
                  <span className="">+</span>
                  <span className="font-medium text-sm">Add New Trigger Channel</span>
                </button>
              </div>
              ...
              >
                {channelFields.map((item, index) => (
                  <AccordionItem key={item.id} value={`${index}`}>
                    <AccordionTrigger>Trigger Channel {index + 1}</AccordionTrigger>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-col">
                              ...
                              <Popover
                                open={openTriggerChannelPopover}
                                onOpenChange={setOpenTriggerChannelPopover}
                              >
                                <PopoverTrigger asChild>
                                  <FormControl>
                                    <ButtonV2
                                        ...
                                        {channelOptions.map((channel) => (
                                          <CommandItem
                                            ...
                                            onSelect={() => {
                                              ...
                                              setOpenTriggerChannelPopover(false);
                                            }}
                                          >
                                            {channel.label}
                                            <HiCheck
